...
if (temperature >= 80 && rain) {
  console.log ("Wear a t-shirt but pack an umbrella.");
} else if (temperature >= 80 && !rain ) {
    console.log ("Wear a t-shirt.");
} else if (temperature <= 60 && temperature >= 80 && rain) {
console.log ("Wear a rain jacket and pack an umbrella.");
} else if (temperature <= 60 && temperature >= 80 && !rain) {
console.log ("Wear a hoodie.");
} else if (temperature <= 60 && rain){ 
console.log ("Wear a coat and pack an umbrella.") 
} else if (temperature <= 60 && !rain) {
  console.log ("Wear a coat.")
} else { 
console.log ("Wear a tank top and a smile.")  
}
...
changeMyMind = true;
console.log ("Change my mind is ", changeMyMind);
